    ...
    <main className="shell">
      ...
      <section className="hero">
        <div>
          ...
          <h1>{(english ? ["Break the rules.", "Claim your sound.", "Join the rebellion."] : ["Spreng die Regeln.", "Zeig deinen Sound.", "Werde Teil der Rebellion."]).map((line) => <span key={line}>{line}</span>)}</h1>
